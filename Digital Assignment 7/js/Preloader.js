...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		//Update assets
		this.load.image('faze','assets/face.png');
		this.load.audio('shift','assets/final-fantasy-viii-sound-effects-draw-point.mp3');
		this.load.audio('damage','assets/emerald 000E - Hit Super Effective.mp3');
	},
