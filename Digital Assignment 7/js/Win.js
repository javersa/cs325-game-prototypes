...
BasicGame.Win.prototype = {
	...
	replay: function (pointer){
		...
		this.game.state.states['Game1'].health1 = 1800;
		this.game.state.states['Game1'].health2 = 1800;
		this.game.state.states['Game1'].super1 = 0;
		this.game.state.states['Game1'].super2 = 0;

		this.game.state.states['Game2'].health1 = 1800;
		this.game.state.states['Game2'].health2 = 1800;
	...
	characterSelect: function (pointer){
		...
		this.game.state.states['Character'].music.volume = 0.4;
	...
	stageSelect: function (pointer){
		...
		this.select.volume = 0.2;
		this.music.stop();
		this.game.state.states['Stage'].music.play(null,null,1,true,true);
		this.game.state.states['Stage'].music.volume = 0.4;
        if (this.isPlayer1 == 1){
            this.game.state.states['Game1'].isPlayer1 = 1;
            this.game.state.states['Game1'].reload1 = 6;
            this.game.state.states['Game2'].isPlayer1 = 1;
