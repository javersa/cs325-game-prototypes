...
BasicGame.Game2.prototype = {
	create: function () {
		...
		if (this.isPlayer2 == 1){
			...
			this.range = 150;
			this.superR = 400;
			this.superDescript = this.add.text(25,772,"Onslaught: Player 1 loses 800+ health.", {font: "24px Times New Roman", fill: "black", align: "center"});
		}
	...
	meleeAttack: function (pointer) {
		if (this.no == true){
		this.tween.pause();
		this.tween1 = this.add.tween(this.player1).to({alpha: 0.5},100,"Linear",true,0,-1);
